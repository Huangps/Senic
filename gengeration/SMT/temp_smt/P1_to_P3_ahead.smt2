; SMT约束：检查B是否在A的ahead侧且距离在[range_x, range_x+5]范围内
...
; ahead角度范围
(define-fun theta_min () Real (normalize_angle_deg (+ A_heading -10.0)))
(define-fun theta_max () Real (normalize_angle_deg (+ A_heading 10.0)))
