...
(ite (and (let ((angle_deg (* (- (atan2 (- vy0 y0) (- vx0 x0)) (/ 3.141592653589793 2.0)) (/ 180.0 3.141592653589793))))(let ((norm_angle (ite (>= angle_deg 360.0) (- angle_deg 360.0) (ite (< angle_deg 0.0) (+ angle_deg 360.0) angle_deg))))(let ((theta_min (let ((raw (+ h0 260))) (ite (>= raw 360.0) (- raw 360.0) (ite (< raw 0.0) (+ raw 360.0) raw)))))(let ((theta_max (let ((raw (+ h0 280))) (ite (>= raw 360.0) (- raw 360.0) (ite (< raw 0.0) (+ raw 360.0) raw)))))(ite (<= theta_min theta_max)(and (>= norm_angle theta_min) (<= norm_angle theta_max))(or (>= norm_angle theta_min) (<= norm_angle theta_max))))))) (>= dist_v0_ego dist_low_v0_ego) (<= dist_v0_ego dist_high_v0_ego)) 4  5 
 ))))) (=> (= relation_v0_ego 5) (let ((delta_x_global (- vx0 x0))      (delta_y_global (- vy0 y0)))  (let ((heading_rad (* h0 (/ 3.141592653589793 180.0))))    (let ((local_x (+ (* (- (sin heading_rad)) delta_y_global) (* (cos heading_rad) delta_x_global)))          (local_y (+ (* (sin heading_rad) delta_x_global) (* (cos heading_rad) delta_y_global))))      (and (>= local_x local_x_v0_ego) (<= local_x (+ local_x_v0_ego 5))           (>= local_y local_y_v0_ego) (<= local_y (+ local_y_v0_ego 5)))))))
) 
 )
...
(assert (=> (= head_relation_v1_ego 3) (let ((rel_heading (- vh1 h0)))  (let ((norm_rel (ite (>= rel_heading 360.0) (- rel_heading 360.0) (ite (< rel_heading 0.0) (+ rel_heading 360.0) rel_heading))))    (and (>= norm_rel  relative_angle_v1_ego ) (<= norm_rel (+ relative_angle_v1_ego 10)) (>= relative_angle_v1_ego 0) (< relative_angle_v1_ego 360))))))
...
(assert (=> (= head_relation_v1_v0 3) (let ((rel_heading (- vh1 vh0)))  (let ((norm_rel (ite (>= rel_heading 360.0) (- rel_heading 360.0) (ite (< rel_heading 0.0) (+ rel_heading 360.0) rel_heading))))    (and (>= norm_rel  relative_angle_v1_v0 ) (<= norm_rel (+ relative_angle_v1_v0 10)) (>= relative_angle_v1_v0 0) (< relative_angle_v1_v0 360))))))
